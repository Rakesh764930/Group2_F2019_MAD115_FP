...
class Singleton: NSObject {
    ...
    func alreadyEmployee() {
        ...
        let f1 = FullTime(name: "Ajeet Singh", age: 22, bonus: 250, salary: 25000,type: "FullTime")
        ...
        let p1 = FixedBasedPartTime(fixedAmount: 500, rate: 10, hoursWorked: 40, name: "Rakesh Kumar", age: 22, type: "Fixed Based PartTime")
